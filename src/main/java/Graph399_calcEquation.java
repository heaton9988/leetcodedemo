...
public class Graph399_calcEquation {
    ...
    public static void main(String[] args) {
        ...
        Graph399_calcEquation obj = new Graph399_calcEquation();
//        List<List<String>> equations = Arrays.asList(Arrays.asList("a", "b"), Arrays.asList("b", "c"));
//        double[] values = new double[]{2.0, 3.0};
        List<List<String>> equations = Arrays.asList(Arrays.asList("a", "b"), Arrays.asList("c", "d"), Arrays.asList("b", "c"));
        double[] values = new double[]{10.0, 10.0, 10.0};
