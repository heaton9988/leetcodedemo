...
public class Backtracking140_wordBreak_trie_timeout {
    ...
    public static void main(String[] args) {
        ...
        Object o = new Backtracking140_wordBreak_trie_timeout().wordBreak("pineapplepenapple", Arrays.asList("apple", "pen", "applepen", "pine", "pineapple"));
